...
const Navbar=()=>{
    ...
    return <div id="Navbar">
        ...
        <Link to={"/login"} style={{textDecoration:"none",color:"black"}}><div id="User"><i class="fa-solid fa-user"></i><span id="Profile">{JSON.parse(localStorage.getItem("Profile"))||"Login"}</span></div></Link>
